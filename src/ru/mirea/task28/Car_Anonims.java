...
public class Car_Anonims {
    String model;
    String name;
    Wheels wheels;

    public Car_Anonims(String model, String name, int radius) {
        this.model = model;
        this.name = name;
    ...
    public static void main(String[] args){
        Car_Anonims anonClownCar = new Car_Anonims("Ferrari", "clowncar LUX", 50){
            @Override
            public void sound(){
        ...
        Car_Anonims justCar = new Car_Anonims("Chevrolet", "Niva", 45);
